...
////////////////////
        ...
        jpButton.add(new JLabel("          "));//com.cleo.dummy Label
        ...
        add(new JLabel("  "), BorderLayout.EAST);//com.cleo.dummy label
        add(new JLabel("  "), BorderLayout.WEST);//com.cleo.dummy label
